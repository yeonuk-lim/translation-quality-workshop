...
├── data/
│ ├── ko_faq.json # 한국어 원본
│ ├── en-rUS_faq.json # 미국 영어 버전
│ └── en-rGB_faq.json # 영국 영어 버전
├── lab_outputs/ # 실습 결과 저장 (자동 생성)
...
│ ├── translations_improved.json
│ ├── eval_improved.json
│ └── summary_report.json
├── lab1_setup.ipynb # 환경 설정
├── lab2_translation_techniques.ipynb  # 번역 기법 비교
├── lab3_eval_faithfulness.ipynb  # 충실도 평가
├── lab4_eval_terminology.ipynb # 용어 일관성 평가
├── lab5_eval_culture_tone.ipynb  # 문화/톤 평가
├── lab6_feedback_retranslation.ipynb  # 피드백 기반 재번역
├── lab7_summary.ipynb # 종합 분석
└── README.md
...
- [Claude 모델 가이드](https://docs.anthropic.com/)
